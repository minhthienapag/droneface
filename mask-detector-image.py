...
weightsPath = os.path.sep.join([args["yolo"], "yolov4-tiny-3l.weights"])
configPath = os.path.sep.join([args["yolo"], "yolov4-tiny-3l.cfg"])
...
if len(idxs) > 0:
	...
	for i in idxs.flatten():
		...
		cv2.imwrite("output/output_crop/crop_face_{}.png".format(str(i)), crop_face)
